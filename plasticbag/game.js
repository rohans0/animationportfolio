...
var ASM_CONSTS = {
    ...
    25990: () => document.getElementById("canvas").width,
    26042: () => parseInt(document.getElementById("canvas").style.width),
    26110: () => {
    ...
    26256: () => document.getElementById("canvas").width,
    26308: () => screen.width,
    26333: () => {
        document.exitFullscreen()
    },
    ...
    26493: () => window.innerWidth,
    26519: () => window.innerHeight,
    26546: () => {
        if (document.fullscreenElement) return 1
    },
    26592: () => document.getElementById("canvas").width,
    26644: () => parseInt(document.getElementById("canvas").style.width),
    26712: () => {
        if (document.fullscreenElement) return 1
    },
    26758: () => document.getElementById("canvas").width,
    26810: () => screen.width,
    26835: () => window.innerWidth,
    26861: () => window.innerHeight,
    26888: () => {
        if (document.fullscreenElement) return 1
    },
    26934: () => document.getElementById("canvas").width,
    26986: () => screen.width,
    27011: () => {
        document.exitFullscreen()
    },
    ...
    27084: () => document.getElementById("canvas").width,
    27136: () => parseInt(document.getElementById("canvas").style.width),
    27204: () => {
        document.exitFullscreen()
    },
    27231: $0 => {
    ...
    27289: () => screen.width,
    27314: () => screen.height,
    27340: () => window.screenX,
    27367: () => window.screenY,
    27394: $0 => {
    ...
    27948: () => window.innerWidth,
    27974: () => window.innerHeight,
    28001: () => {
